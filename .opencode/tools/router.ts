...
export default class RouterTool extends Tool {
    static metadata = {
        name: "router",
    ...
    async run({ prompt, model_preference = "chat" }) {
        // Simple routing logic:
        // For now, we route everything to vLLM since it's our active backend.
        // In the future, we can check health endpoints of SGLang/Ollama and route accordingly.
